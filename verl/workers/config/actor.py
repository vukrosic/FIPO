...
class ActorConfig(BaseConfig):
    ...
    Args:
        ...
        logprob_entropy_impl (str): Backend for the fused logprob+entropy helper in the DP actor path.
    ...
    # NOTE: kx add reweight_method and reweight_c here
    reweight_method: str = "none"  # reweight method, default is 'none'
    reweight_c: float = 0.0
